...
basicStyling = function(answer_span,top_elements){
    ...
    jq(answer_span).css('min-height', 200);
    ...
    // top_elements.wrapper.css('min-width',700+10);
    // top_elements.wrapper.css('width',2000+10);
    // top_elements.toolbar.css('min-width',700);
    // top_elements.toolbar.css('max-width',700);
    // top_elements.toolbar.css('width',2000);
